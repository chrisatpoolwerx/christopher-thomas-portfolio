...
export const PROJECTS: Project[] = [
  {
    ...
    context: "Pool maintenance is information-dense, technical, and often reactive. Most tools present raw measurements like pH, chlorine, and alkalinity, leaving homeowners to interpret specialist data without expertise.\n\nPoolchex reimagines this relationship entirely. Instead of visualizing chemistry, the product behaves like an expert: interpreting readings, generating treatment plans on-device, and guiding owners toward resolution with clarity and confidence. The ambition was to design an experience that felt contextual, intelligent, and deeply native to iOS.",
    ...
    craft: [
      { section: 'The Animated Water Field', content: 'Every screen is backed by a mathematically generated water simulation: a live mesh driven by interfering wave equations that combine slow structural swells with higher-frequency surface ripples.' },
  ...
  throughLine: 'This project extended my focus on behavioral design, shaping services that build confidence through continuity.',
  context: 'Traditional pool service is transactional. Technicians fix immediate problems, but owners rarely understand the full picture of their pool\'s health. Healthy Pool Plan reimagined this interaction as a comprehensive diagnostic experience that documents current conditions, identifies emerging issues, and provides clear guidance on what matters most. \n\nThis allowed Poolwerx to evolve from one-off servicing into an ongoing relationship underpinned by communication and trust.',
  role: 'Lead Product Designer',
  scope: [
  ...
  modelDescription: 'The experience was structured as a systematic diagnostic journey, where technicians document pool structure, equipment, water quality, and safety systems in detail, then the system synthesizes this data into a clear narrative of pool health with prioritized recommendations.',
  principles: [
  ...
  craft: [
    ...
    { title: 'Report Hierarchy', description: 'Structured the output to prioritize critical issues while providing complete detail, so customers see what matters most first with full documentation available when needed.' },
  ...
  },
  {
    ...
    momentumDescription: 'A clear progress model reduced hesitation at each step. Customers moved through customization with fewer pauses, and completion rates improved with the progressive flow.',
    ...
    principles: [
      ...
      { title: 'Continuous Feedback', description: 'Progress is always visible, so users know exactly where they are in the journey.' }
    ],
    craft: [
  ...
  },
  {
    ...
    oneLine: 'Turning pizza customization into a joyful, high-conversion spatial experience, integrated directly into Domino\'s online ordering.',
    ...
    hardThings: [
      ...
      'Making "joy" real: delight had to be intentional, controlled, and supportive of comprehension'
    ],
    ...
    arOptionalDescription: "For devices without ARKit, or users who preferred not to place a pizza on the floor, we added a camera-off toggle and rendered the pizza against a neutral background.",
    principles: [
    ...
    outcomes: [
      ...
      'Recognised by IDC\'s 2019 Digital Transformation Awards as Omni Experience Innovator, with an overall global category win',
    ...
    reflection: "The biggest learning was restraint: the best 'wow' moments made the workflow feel more natural. The bar for delight in commerce is high, and it has to earn its place by improving comprehension and momentum.",
